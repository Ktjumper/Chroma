 ...
 */
public class ScreenLevelSelectEasy implements Screen {
    private Stage stage;
    private Table table;
    ...
    public void show() {
        ...
        Texture titleT = Assets.manager.get("easyText.png", Texture.class);
        ...
        for(int i = 0; i < 3; i++) {
            for(int j = 0; j < 5; j++) {
                ...
                TextButton b = new TextButton(Integer.toString(levelNum), skin, row);
                b.setName("" + levelNum);
