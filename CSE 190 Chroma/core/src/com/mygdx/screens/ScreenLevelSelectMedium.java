 ...
 */
public class ScreenLevelSelectMedium implements Screen {
    private Stage stage;
    private Table table;
    ...
    public void show() {
        ...
        Texture titleT = Assets.manager.get("mediumText.png", Texture.class);
        ...
        for(int i = 0; i < 3; i++) {
            for(int j = 0; j < 5; j++) {
                ...
                TextButton b = new TextButton(Integer.toString((((j + 1) + i * 5)) + 15 * 1), skin, row);
                b.setName("" + ((((j + 1) + i * 5)) + 15 * 1));
